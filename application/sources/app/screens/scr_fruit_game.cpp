...
static void fruit_game_clear_timeout() {
    timer_remove_attr(AC_TASK_DISPLAY_ID, AC_DISPLAY_SHOW_IDLE);
}

static void fruit_game_save_score() {
    ar_game_score_t score;
    uint32_t score_save = (fruit_game_score > 0) ? (uint32_t)fruit_game_score : 0;
